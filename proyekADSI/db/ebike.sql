...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 04, 2024 at 06:17 PM
...
INSERT INTO `detail_penyewaan` (`id`, `status`, `id_penyewaan`, `id_ebike`) VALUES
(1, 2, 1, 1),
(2, 2, 2, 1),
(3, 2, 2, 2),
(4, 2, 3, 1),
...
INSERT INTO `penyewaan` (`id`, `status`, `harga`, `jam_sewa`, `id_akun`) VALUES
(1, 2, 176000, 11, 2),
(2, 2, 0, 0, 2),
(3, 2, 528000, 22, 2),
(4, 1, 528000, 22, 2);
