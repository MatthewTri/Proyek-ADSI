...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
            <div class="container-fluid">
                <a class="navbar-brand ms-4">
                    <img src="/proyekADSI/resources/electric.png" width="50" height="40" alt="">
                </a>
        ...
        <div id="carouselExample" style="width: 70%; transform: translate(20%, 0%); margin-bottom: 50px;" class="carousel slide">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="/proyekADSI/resources/e-bike1.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>

                <div class="carousel-item">
                    <img src="/proyekADSI/resources/e-bike2.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="/proyekADSI/resources/e-bike3.webp" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="/proyekADSI/resources/e-bike1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="/proyekADSI/resources/e-bike2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card mb-4">
                    <img src="/proyekADSI/resources/e-bike3.webp" class="card-img-top" alt="...">
                    <div class="card-body">
