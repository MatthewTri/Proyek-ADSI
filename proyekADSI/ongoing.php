...
<div class="navbar-area">
        <nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color: #09111a;">
            <div class="container-fluid">
                <a class="navbar-brand ms-4"> <img src="/proyekADSI/resources/electric.png" width="50" height="40" alt="">
                </a></a>
            ...
            <?php else : ?>
                ...
                <table class="table">
                    <thead class="table-dark">
                        ...
                        <th scope="col" width="100">ID_Penyewaan</th>
                        <th scope="col" width="100">ID_Ebike</th>
