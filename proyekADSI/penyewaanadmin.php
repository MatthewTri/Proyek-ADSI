...
if (isset($_POST['entry'])) {
    ...
    $jam = $_POST['jam'];
    $id = $_GET['id'];
    $msg = $ebikeui->editPenyewaan($penyewaan, $id, $status, $harga, $jam);
}
?>
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-start flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="penyewaanadmin.php">Penyewaan</a>
                            </li>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
                <form method="post">
                    ...
                    <?php
                        if (isset($_GET['edit'])) {
                            echo '<h2>Edit Penyewaan - ' . $_GET['id'] . '</h2>
                            <p>status</p>
                            ...
                            <p>Jam Sewa</p>
                            <input type="text" name="jam" id="" class="form-control form-control-lg"><br/>
            ...
            if ($check_data->rowCount() == 0) : ?>
                <p>Tidak ada penyewaan yang ditambahkan.</p>
            <?php else : ?>
                ...
                <table class="table">
                    <thead class="table-dark">
                        ...
                        <th scope="col" width="200">Jam Sewa</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a style="padding-left: 24px; padding-right: 24px; font-size: 18px" href="penyewaanadmin.php?id= <?= $data['id'] ?>&edit=1" class="btn btn-primary btn-sm">Edit</a>
                                    <a style="padding-left: 24px; padding-right: 24px; font-size: 18px" href="detailpenyewaanadmin.php?idpenyewaan= <?= $data['id'] ?>" class="btn btn-primary btn-sm">View</a>
                                </td>
                            </tr>
                        <?php endforeach?>
                    </tbody>
